# Decompile by Picci Roman king (Tools By Cobra-Linux Picci Roman king)
# Dont ader restiment with Roman
# Decode file /- NA Cobra PYC 3.11
# DECODE FILE VERSION - V.3.1.1
# WHATSAPP - +8801881482391
import os
import time
os.system("clear")
print("  ==> \033[1;32mTHIS TOOLS DECODE BY (Picci Roman king) ")
time.sleep(5)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/Hi.Baby.Its.Me.roman.king.20b"])
	exit(" [*] WHATSAPP - +8801881482391")
...
def notice():
	...
	runtxt("\033[0;92m BYPASS ADMIN WHATSAPP  >> +8801881482391")
	runtxt("\033[0;95m    <===================☠️  \033[0;97mEXIT\033[0;95m ☠️===================> ")
	subprocess.check_output(["am", "start", "https://Hi.Baby.Its.Me.roman.king"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://www.facebook.com/Hi.Baby.Its.Me.roman.king.20b').text
			if basesplit in plr:
				key = basesplit
